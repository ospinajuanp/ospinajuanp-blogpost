...
# 📌 Sesión 19 Feb - Temas vistos

* **Revisar formato de proyectos:** Es necesario enviar la información al vocero para unificar la actividad de los grupos.
* **Explicación de evidencia:** Se detallaron los requisitos para la entrega del mapa mental (GA1-220501046-AA1-EV01).
* **Conceptos clave:** Definición de software, tipos de software, servicios de internet y herramientas colaborativas.
* **Link de grupos:** Organización y acceso a los equipos de trabajo.
* **Dudas e inquietudes:** Espacio para resolver preguntas de los aprendices.
...
* **De Sistema:** Es el que manda en el equipo y administra los recursos del hardware, como Windows, Linux, macOS o Android.
* **De Aplicación:** Los programas que usamos para tareas específicas: Word, el navegador, Excel o incluso los videojuegos.
* **De Programación:** Las herramientas que usan los desarrolladores para crear otros programas, como editores de texto y compiladores (ej. VS Code).
...
La sesión permitió aclarar que el entendimiento correcto de las herramientas TIC y la organización mediante metodologías colaborativas son la base para el éxito del proyecto. Validar estos conceptos a tiempo evita errores costosos en las fases posteriores de desarrollo.